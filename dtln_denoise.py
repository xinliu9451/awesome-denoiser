...
block_shift = 128
# load models
interpreter_1 = tflite.Interpreter(model_path='example_data/model_1.tflite')
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(model_path='example_data/model_2.tflite')
...
def infer(audio_path):
    ...
    return out_file.astype(np.float32), fs
    
    
def dtln_denoise(audio_input1, audio_input2, dB, min_silence_duration):
    start = time.time()
